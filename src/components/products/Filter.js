...
import { getProducts, filterProducts , setPageNumber } from '../../actions/productsAction';
// 
               ...
               <aside className="filter-wrapper">
                  ...
                  >
                     ...
                     <div className="brand">
                        ...
                        >
                           <option value='' disabled>Brend</option>
                           {
                              subcategorie.brands &&
                     ...
                     {/* size */}
                     {
                        subcategorie.sizeType &&
                        subcategorie.sizeType.size_names && (
                           <div className="size">
