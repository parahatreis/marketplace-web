...
const HomeProductItem = ({
  ...
  useEffect(() => {
    if (cart) {
      const findProduct = cart.findIndex(
        ...
        <div className="product-item">
          <Link to={`/products/${product_id}`} className="image-wrapper">
            {old_price && product_discount > 0 && (
              <div className="percentage">-{product_discount}%</div>
            )}
            {!isImageLoaded && (
              <LazyLoadImage
                effect="blur"
          ...
          <div className="upper-block">
            ...
            <div className="floor-block">
              <div className="price">
                ...
                {old_price && <div className="old-price">{old_price} TMT</div>}
              </div>
              {stocks && stocks[0].stock_quantity > 0 && (
