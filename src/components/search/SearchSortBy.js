...
// 
import { searchProducts, setPageNumber, setSortBy } from '../../actions/productsAction';

const SearchSortBy = ({ products : { page_number},searchProducts, setSortBy,setPageNumber, query }) => {
